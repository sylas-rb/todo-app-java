...
public class TarefaFluxoTest {
    ...
    class CaminhoCorreto {
        ...
        public void confirmacaoTarefaTest() {
            ...
            boolean verdadeiroM = funcoes1.confirmacaoTarefa(listTeste, id1);
            boolean verdadeirom = funcoes2.confirmacaoTarefa(segundaList, id2);
        ...
        @Test
        @DisplayName("Verificando se a tarefa foi marcada e movida para outra lista")
        public void marcaTarefaTest() {
            Scanner teste = new Scanner("1\n s\n");
            entrada1 = new EntradaConsole(teste, OutPut);

            funcoes1 = new TarefaFluxo(entrada1, tarefasRep, OutPut);

            Tarefa tarefa = new Tarefa(1L, "Teste1", "Teste descrição", Status.PENDENTE, Prioridade.BAIXA, date, "25/08/2026");
            t1.setId(1L);

            segundaList.add(tarefa);
            listTeste.add(t1);

            funcoes1.marcaTarefa(segundaList, listTeste);

            assertEquals(Status.CONCLUIDA, tarefa.getStatus());
            assertEquals(2L, tarefa.getId());
            assertEquals(2, listTeste.size());
            assertEquals(0, segundaList.size());
        }
        ...
        public void removendoTarefaTest() {
            ...
            funcoes1.removendoTarefa(listTeste);
    ...
    class CaminhoErrado{
        ...
        @Test
        @DisplayName("Verificando se retornou mensagem se a entrada for errado")
        public void marcaTarefaTest() {
            Scanner teste = new Scanner("asa\n 1\n s\n");
            entrada1 = new EntradaConsole(teste,  OutPut);
            funcoes1 = new  TarefaFluxo(entrada1, tarefasRep, OutPut);
            ...
            //Neste teste a função marcaTarefa chama uma função por dentro que adiciona o 'id' do t1 com mais 1, então tarefa t1 igual a 2L
        }
    ...
    class CaminhoExcesoes {
        ...
        public void confirmacaoTarefaTest() {
            ...
            assertThrows(TarefaException.class, () -> funcoes1.confirmacaoTarefa(segundaLista, id2));
        }
        ...
        public void confirmacaoTarefaNullTest() {
            ...
            assertThrows(TarefaException.class, () -> funcoes1.confirmacaoTarefa(segundaList, id2));
        }
        ...
        public void removendoTarefaTest() {
            ...
            assertThrows(TarefaException.class, () -> funcoes1.removendoTarefa(listTeste));
        }
    }
}
